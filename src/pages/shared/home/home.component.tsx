...
const Home = () => {
  ...
  const homeCardContent = {
    ...
    livePrices: {
      header: "Live Prices",
      description: "Get live price updates by the minute on stocks, indices, crypto and foreign exchange with our Realtime API",
      imageUrl: "https://media.istockphoto.com/id/1372102011/vector/business-analyst-financial-data-analysis-advisor-analyzing-financial-report.jpg?s=612x612&w=0&k=20&c=LpfJhQ4yLFPh-yXebLXpPZFHhDhT3lGzjA2mkGioiLw=",
      path: currentUser ? NAV_LINKS.paths.signedIn.livePrices : NAV_LINKS.paths.signedOut.livePrices
    },
    predictions: {
      header: "Predictions",
      description: "View predictions on some stocks and crypto, generated by time-series forecasting models",
      imageUrl: "https://png.pngtree.com/png-clipart/20230824/original/pngtree-team-leader-employee-get-promotion-picture-image_8370740.png",
      path: currentUser ? NAV_LINKS.paths.signedIn.predictions : NAV_LINKS.paths.signedOut.predictions
    },
    alerts: {
      header: "Alerts",
      description: "Subscribe to alerts on changes for symbols, and receive email notifications",
      ...
      path: currentUser ? NAV_LINKS.paths.signedIn.alerts : NAV_LINKS.paths.signedOut.alerts
    },
    market: {
      header: "Market",
    ...
    <div className="container">
      <HomeContainer>
        <div className="row justify-content-center align-items-center">
          ...
          <div className="col-sm-12 col-md-6 col-lg-4">
            <MediaCard styles={ cardStyles } header={ homeCardContent.livePrices.header } imageUrl={ homeCardContent.livePrices.imageUrl } 
            imageTitle={ homeCardContent.livePrices.header } path={ homeCardContent.livePrices.path } content={ homeCardContent.livePrices.description }></MediaCard>
          </div>
          ...
          <div className="col-sm-12 col-md-6 col-lg-4">
            <MediaCard styles={ cardStyles } header={ homeCardContent.alerts.header } imageUrl={ homeCardContent.alerts.imageUrl } 
            imageTitle={ homeCardContent.alerts.header } path={ homeCardContent.alerts.path } content={ homeCardContent.alerts.description }></MediaCard>
          </div>
