...
const TransactionInfo = ({ date, amount, type, reason, addToExpenses = false }: TransactionInfoProps) => {
  return (
    <Fragment>
      {
...
const Transaction = ({ date, amount, type, reason, addToExpenses = false }: TransactionInfoProps) => {
