import "./expenses-summary.styles.tsx"
import { ExpensesSummaryInfoContainer } from "./expenses-summary.styles.tsx"
import { useContext } from "react"
// import { ExpensesContext } from "../../../../contexts/signed-out/expenses/expenses.context"

import { useSelector } from "react-redux"
import { selectExpensesView, selectFilterConditions, selectExpensesSummary } from "../../../../store/signed-out/expenses/expenses.selector.ts"
  ...
  return (
    <ExpensesSummaryInfoContainer>
      <SimplePaper styles={ paperStyles }>
        <Typography variant="h6">{ `Total spend: $${expensesSummary?.currentAllExpensesCost?.toFixed(2)}` }</Typography>
